...
- [Report-Scraper](https://github.com/trybadisch/Report-Scraper): Firefox extension to scrape summaries of HackerOne reports including status, last action, and last message
